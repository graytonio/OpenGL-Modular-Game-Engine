...
public class TimedSystem extends ParticleSystem{
	...
	public TimedSystem(ParticleTexture texture, Vector3f origin, float pps, float speed, float gravityComplient, float lifeLength, float scale, float duration) {
	...
	public boolean generateParticles() {

...
public class GeneralSystem extends ParticleSystem{
	...
	public GeneralSystem(ParticleTexture texture, Vector3f origin, float pps, float speed, float gravityComplient, float lifeLength, float scale) {
